...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()(
  {
    head: () => ({
      meta: [
        ...
        { name: "author", content: "Suraj Construction Company" },
        { property: "og:type", content: "website" },
        { name: "twitter:card", content: "summary_large_image" },
        {
          property: "og:title",
          content:
            "Suraj Construction Company | Road & Infrastructure Builders",
        },
        {
          name: "twitter:title",
          content:
      ...
      links: [
        ...
        { rel: "preload", as: "video", href: "/hero.mp4" },
  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        <script
          async
          src="https://www.googletagmanager.com/gtag/js?id=G-QEZZEDP6ML"
        />
        <script
